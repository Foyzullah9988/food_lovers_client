            ...
            <div className=" py-16">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-8">
                        <h2 className="text-4xl font-bold mb-2 text-[#5E6D63]">Foodie Tips & Guides</h2>
                    ...
                    <div className="grid gap-8 sm:grid-cols-2 xl:grid-cols-4">
                        {
                            data.map(d => <div key={d.id} className="bg-[#F3EFEA] rounded-xl shadow-lg overflow-hidden hover:scale-105 transition-transform duration-300 flex flex-col p-3">
                                ...
                                <div className='flex justify-end'>
                                    <a href="https://www.cordonbleu.edu/london/cookery-tips-food-guides/en" className="bg-[#e2c6a3] text-white px-4 py-2 rounded-md hover:bg-[#F3EFEA] transition-colors">Learn More</a>
                                </div>
                            </div>)
                        }
                    </div>
